...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="group flex items-center gap-1.5 font-sans text-[#333333]/50 text-[0.82rem] hover:text-[#333333] transition-colors duration-200 py-1"
    >
      {children}
    ...
    <footer className="bg-[#F4F4F4] border-t border-[#D6D3CE]">
      ...
      <div className="border-b border-[#D6D3CE]">
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-10 lg:py-12">
          <div className="max-w-2xl mx-auto">
            <p className="font-sans text-[0.58rem] tracking-[0.32em] uppercase text-[#333333]/40 text-center mb-3">
              Stay Connected
            </p>
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-8">
        ...
        <div className="hidden lg:grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-14 py-16">
          ...
          <div>
            ...
            <p className="font-sans text-[#333333]/50 text-sm leading-relaxed max-w-[260px] mb-8">
              Premium handcrafted planters and outdoor décor that elevate every space they inhabit.
            </p>
            <div className="space-y-3">
              <a href="tel:8775337687" className="flex items-center gap-2.5 text-[#333333]/45 hover:text-[#333333] transition-colors duration-200">
                <Phone size={12} strokeWidth={1.5} />
                <span className="font-sans text-xs">(877) 533-7687</span>
              </a>
              <a href="mailto:hello@jacksonpottery.com" className="flex items-center gap-2.5 text-[#333333]/45 hover:text-[#333333] transition-colors duration-200">
                <Mail size={12} strokeWidth={1.5} />
                <span className="font-sans text-xs">hello@jacksonpottery.com</span>
              </a>
              <a href="https://instagram.com/jacksonpottery" className="flex items-center gap-2.5 text-[#333333]/45 hover:text-[#333333] transition-colors duration-200">
          ...
          {/* Collections */}
          <div>
            <h4 className="font-sans text-[0.56rem] tracking-[0.38em] uppercase text-[#333333]/40 mb-6">Collections</h4>
          ...
          {/* Shop by Space */}
          <div>
            <h4 className="font-sans text-[0.56rem] tracking-[0.38em] uppercase text-[#333333]/40 mb-6">By Space</h4>
            <ul className="space-y-3.5">
              {spaces.map((item) => (
                <li key={item}><NavLink href="/shop">{item}</NavLink></li>
              ))}
          ...
          {/* Support */}
          <div>
            <h4 className="font-sans text-[0.56rem] tracking-[0.38em] uppercase text-[#333333]/40 mb-6">Support</h4>
            <ul className="space-y-3.5">
              {support.map((item) => (
                <li key={item}><NavLink href="/shop">{item}</NavLink></li>
              ))}
            ...
            <div className="mt-6 pt-5 border-t border-[#D6D3CE]">
              <Link
                href="/wholesale"
                className="group flex items-center gap-1.5 font-sans text-[#333333]/45 text-[0.82rem] hover:text-[#333333] transition-colors duration-200 py-1"
              >
                Dealer Login
                <ArrowRight size={10} strokeWidth={1.5} className="opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 flex-shrink-0" />
              </Link>
              <p className="font-sans text-[#333333]/35 text-[0.7rem] mt-1.5 leading-relaxed">
        ...
        <div className="lg:hidden py-12 flex flex-col items-center text-center gap-9">
          ...
          {/* Tagline */}
          <p className="font-sans text-[#333333]/50 text-sm leading-relaxed max-w-[280px]">
            Premium handcrafted planters and outdoor décor that elevate every space they inhabit.
          </p>

          {/* Contact icons */}
          <div className="flex items-center justify-center gap-5">
            <a href="tel:8775337687" aria-label="Call us" className="w-10 h-10 rounded-full border border-[#D6D3CE] flex items-center justify-center text-[#333333]/45 hover:text-[#333333] hover:border-[#333333]/40 transition-all duration-200">
              <Phone size={14} strokeWidth={1.5} />
            </a>
            <a href="mailto:hello@jacksonpottery.com" aria-label="Email us" className="w-10 h-10 rounded-full border border-[#D6D3CE] flex items-center justify-center text-[#333333]/45 hover:text-[#333333] hover:border-[#333333]/40 transition-all duration-200">
              <Mail size={14} strokeWidth={1.5} />
            </a>
            <a href="https://instagram.com/jacksonpottery" aria-label="Instagram" className="w-10 h-10 rounded-full border border-[#D6D3CE] flex items-center justify-center text-[#333333]/45 hover:text-[#333333] hover:border-[#333333]/40 transition-all duration-200">
          ...
          <div className="flex items-center gap-4 w-full max-w-xs">
            ...
            <span className="font-sans text-[0.5rem] tracking-[0.4em] uppercase text-[#333333]/30">Since 2009</span>
            <div className="h-px flex-1 bg-[#D6D3CE]" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-10 gap-y-3.5 w-full max-w-xs text-left">
            {[
              ...
              <Link
                key={item}
                href="/shop"
                className="font-sans text-[#333333]/50 text-[0.78rem] hover:text-[#333333] transition-colors duration-200"
              >
                {item}
              </Link>
            ))}
            <Link
              href="/wholesale"
              className="font-sans text-[#333333]/45 text-[0.78rem] hover:text-[#333333] transition-colors duration-200"
            >
              ✦ Dealer Login
            </Link>
          </div>
      ...
      <div className="border-t border-[#D6D3CE]">
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-sans text-[#333333]/30 text-[0.6rem] tracking-wide">
            © {new Date().getFullYear()} Jackson Pottery. All rights reserved.
          </p>
          <div className="flex items-center gap-5">
            {['Privacy Policy', 'Terms of Service', 'Accessibility'].map((item) => (
              <a key={item} href="#" className="font-sans text-[#333333]/25 text-[0.6rem] hover:text-[#333333]/55 transition-colors duration-200">
                {item}
              </a>
            ))}
          </div>
